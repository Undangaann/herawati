...
function initConfiguration() {
    ...
    document.querySelectorAll(".parent-info")[0].innerHTML = `Putra Pertama dari Tiga bersaudara<br>${WEDDING_CONFIG.couple.groom.father} & ${WEDDING_CONFIG.couple.groom.mother}`;
    document.querySelectorAll(".parent-info")[1].innerHTML = `Putri ke Tiga dari Empat bersaudara<br>${WEDDING_CONFIG.couple.bride.father} & ${WEDDING_CONFIG.couple.bride.mother}`;
